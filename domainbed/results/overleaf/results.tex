...
\begin{tabular}{lccccc}
\toprule
\multicolumn{6}{l}{\textbf{TerraIncognita.Modelselection: ‘Training-domain’ validationset}}\\
\midrule
\textbf{Algorithm}   & \textbf{L100}        & \textbf{L38}         & \textbf{L43}         & \textbf{L46}         & \textbf{Avg}         \\
\midrule
...
\begin{tabular}{lccccccc}
\toprule
\multicolumn{8}{l}{\textbf{DomainNet.Modelselection: Test-domain’ validationset}}\\
\midrule
...
\toprule
\multicolumn{9}{l}{\textbf{Average across all datasets. Modelselection: ‘Test-domain’ validationset}}\\  
\midrule
...
\begin{tabular}{lcccccccc}
\toprule
\multicolumn{9}{l}{\textbf{Average across all datasets. Modelselection: ‘Training-domain’ validationset}}\\  
\midrule
\textbf{Algorithm}        & \textbf{ColoredMNIST}     & \textbf{RotatedMNIST}     & \textbf{VLCS}             & \textbf{PACS}             & \textbf{OfficeHome}       & \textbf{TerraIncognita}   & \textbf{DomainNet}        & \textbf{Avg}              \\
\midrule
