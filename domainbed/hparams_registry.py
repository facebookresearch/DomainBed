...
def _hparams(algorithm, dataset, random_seed):
    ...
    if algorithm in ['DANN', 'CDANN']:
        ...
        _hparams['cos_lambda'] = (1e-4, lambda r: 10 ** r.uniform(-5, 0))
        _hparams['iters'] = (200, lambda r: int(10 ** r.uniform(0, 4)))
        _hparams['groupdro_eta'] = (1e-2, lambda r: 10 ** r.uniform(-3, -1))
